...
<head>
    ...
    <title>Alumni Sekolah - SMPIT Bina Insan Kamil Sukmajaya Depok</title>
...
<section class="our-teachers">
    <div transition-style="in:square:bottom-left">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h2 class="mb-5">Alumni Sekolah SMPIT Bina Insan Kamil Sukmajaya Depok </h2>
                </div>
            </div>
            <div class="row">
                <?php foreach ($data->result() as $row) : ?>
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="admission_insruction">
                          ...
                          <?php else:?>
                            <img src="<?php echo base_url().'assets/images/'.$row->alumni_photo;?>" class="img-fluid" alt="#">
                          <?php endif;?>
                            <p class="text-center mt-3"><?php echo $row->alumni_nama;?>
                            <p class="text-center mt-3"><?php echo $row->alumni_angkatan;?>
                            <p class="text-center mt-3"><?php echo $row->alumni_jabatan;?>
