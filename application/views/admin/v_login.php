...
<head>
  ...
  <title>Admin Login | Admin - SMPIT Bina Insan Kamil Sukmajaya Depok</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <hr/>
    <p><center>Copyright <?php echo date('Y');?> by SMPIT Bina Insan Kamil Sukmajaya<br/> All Right Reserved</center></p>
  </div>
</div>
