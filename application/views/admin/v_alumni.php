...
<head>
  ...
  <title>Data Alumni | Admin - SMPIT Bina Insan Kamil Sukmajaya Depok</title>
                ...
                <tbody>
          				<?php
          					...
          					foreach ($data->result_array() as $i) :
          					   ...
          					   $id=$i['alumni_id'];
          					   $nama=$i['alumni_nama'];
          					   $angkatan=$i['alumni_angkatan'];
          					   $jabatan=$i['alumni_jabatan'];
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-7">
                                            <input type="text" name="xangkatan" class="form-control" id="inputUserName" placeholder="Angkatan" required>
                                        </div>
                                    </div>
