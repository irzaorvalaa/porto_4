...
<head>
  ...
  <title>Update Artikel | Admin - SMPIT Bina Insan Kamil Sukmajaya Depok</title>
    ...
    <section class="content">
      ...
      <div class="box box-default">
        <div class="box-header with-border">
          <h3 class="box-title">Update Judul Artikel *</h3>
        </div>
		<?php
        $b=$data->row_array();
    ?>
        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-10">
              ...
              <input type="text" name="xjudul" class="form-control" value="<?php echo $b['tulisan_judul'];?>" placeholder="Judul artikel" required/>
            </div>
            <div class="col-md-2">
      ...
      <div class="row">
        <div class="col-md-8">
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Update Deskripsi Artikel</h3>
            </div>
            <div class="box-body">
        ...
        <div class="col-md-4">
          <div class="box box-primary">
            <div class="box-header">
              <h3 class="box-title">Pengaturan Lainnya (Required)</h3>
            </div>
            <div class="box-body">
              <div class="form-group">
