...
?>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url().'admin/pendaftaran'?>"><i class="fa fa-th-list"></i> List Pendaftaran</a></li>
            <li><a href="<?php echo base_url().'admin/pendaftaran/add_pendaftaran'?>"><i class="fa fa-plus"></i> Post Pendaftaran</a></li>
          </ul>
        </li>
        <li class="treeview">
          <a href="#">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="<?php echo base_url().'admin/alumni'?>"><i class="fa fa-graduation-cap"></i>Data Alumni</a></li>
